...
@Component({
  ...
  imports: [ReactiveFormsModule,FormsModule,MatDialogActions,CommonModule],
...
constructor(private fb:FormBuilder,public dialogRef:MatDialogRef<CommentFlagModalComponent>,@Inject(MAT_DIALOG_DATA)public data: {postCommentId: number}){
